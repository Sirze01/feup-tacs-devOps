...
/**
 * This is the item provider adapter for a {@link devOps.Stage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stage_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stage_tasks_feature", "_UI_Stage_type"),
				 DevOpsPackage.Literals.STAGE__TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConditionalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stage_conditional_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stage_conditional_feature", "_UI_Stage_type"),
				 DevOpsPackage.Literals.STAGE__CONDITIONAL,
				 true,
				 false,
				 true,
				 null,

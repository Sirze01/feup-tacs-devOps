...
/**
 * This is the item provider adapter for a {@link devOps.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider extends StepItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_cmd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_cmd_feature", "_UI_Command_type"),
				 DevOpsPackage.Literals.COMMAND__CMD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Command)object).getCmd();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Command.class)) {
			case DevOpsPackage.COMMAND__CMD:
